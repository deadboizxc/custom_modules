...
async def jac(client: Client, message: Message):
    ...
    ufr = requests.get(
        "https://github.com/deadboizxc/zxc-Userbot_files/blob/main/CascadiaCodePL.ttf?raw=true"
    )
    f = ufr.content
    pic = requests.get(
        "https://raw.githubusercontent.com/deadboizxc/zxc-Userbot_files/main/jac.jpg"
    )
